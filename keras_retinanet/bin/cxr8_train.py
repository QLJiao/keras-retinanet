...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.snapshots:
        ...
        checkpoint = keras.callbacks.ModelCheckpoint(
            os.path.join(
                args.snapshot_path,
                'cxr8_{backbone}_{dataset_type}_{{epoch:02d}}.h5'.format(backbone=args.backbone, dataset_type=args.dataset_type)
            ),
            verbose=1,
            # save_best_only=True,
            # monitor="mAP",
...
def parse_args(args):
    ...
    parser.add_argument('--steps',            help='Number of steps per epoch.', type=int, default=8000)
